                ...
                if ($_POST['album'] == "none") {
                    for ($i = 0; $i < $fileCount; $i++) {
                        ...
                        if ($filetype == "jpg" || $filetype == "jpeg" || $filetype == "png" || $filetype == "gif") {
                            ...
                            $db->add_photos($nameShow, $nameReal, $filetype, $size);
                            $cntUploadSuc++;
                        } else {
                            $cntUploadFail++;
                        }
                    ...
                    if ($cntUploadSuc > 0 && $cntUploadFail == 0) {
                        echo "<div id=\"alert\" style='display: none; text-align: center' class=\"alert alert-success\"><h5><i class=\"fa fa-check-circle\" aria-hidden=\"true\"></i>&nbsp;&nbsp;" . $cntUploadSuc . " photos uploads successfully.</h5></div>";
                    } else if ($cntUploadSuc > 0 && $cntUploadFail > 0) {
                        echo "<div id=\"alert\" style='display: none; text-align: center' class=\"alert alert-success\"><h5><i class=\"fa fa-check-circle\" aria-hidden=\"true\"></i>&nbsp;&nbsp;" . $cntUploadSuc . " photos uploads successfully. </h5><h5 style='color: red;'><i class=\"fa fa-exclamation-triangle\" aria-hidden=\"true\"></i>&nbsp;&nbsp;" . $cntUploadFail . " photos upload unsuccessfully. Because photos type inconsistent.</h5></div>";
                    } else {
                        echo "<div id=\"alert\" style='display: none; text-align: center' class=\"alert alert-danger\"><h5 style='color: red;'><i class=\"fa fa-exclamation-triangle\" aria-hidden=\"true\"></i>&nbsp;&nbsp;upload unsuccessfully. Because photos type inconsistent.</h5></div>";
                    }
                } else {
                    $albums_id = $_POST['album'];
                    ...
                    if ($cntUploadSuc > 0 && $cntUploadFail == 0) {
                        $num+=$cntUploadSuc;
                        //echo "cntUploadSuc= ".$cntUploadSuc."<br>num= ".$num."<br>";
